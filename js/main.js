...
function addStyleActiveToButton() {
  ...
  console.log(
    "sizeNameOfIcon: " + typeof sizeNameOfIcon + "\n",
    "sizeIcon: " + typeof sizeIcon + "\n",
    "fullName: " + typeof fullName + "\n",
    "smallName: " + typeof smallName + "\n",
    "iconID: " + typeof iconID + "\n",
    "classListOfSizeIcon: " + typeof classListOfSizeIcon + "\n",
    "classListOfFontIcon: " + typeof classListOfFontIcon + "\n",
    "classNameOfIcon: " + typeof classNameOfIcon + "\n",
    "sizeCondition: " + typeof sizeCondition + "\n",
    "fontCondition: " + typeof fontCondition + "\n",
    "firstPart: " + typeof firstPart + "\n",
    "secondPart: " + typeof secondPart + "\n",
    "fontIcon: " + typeof fontIcon + "\n",
    "fontNameOfIcon: " + typeof fontNameOfIcon + "\n",
    "indentIcon: " + typeof indentIcon + "\n",
    "classListOfIndentIcon: " + typeof classListOfIndentIcon + "\n",
    "classListOfTextIcon: " + typeof classListOfTextIcon + "\n",
    "directionTag: " + typeof directionTag + "\n",
    "classListOfDirection: " + typeof classListOfDirection + "\n",
    "textIcon: " + typeof textIcon + "\n",
    "icon: " + typeof icon + "\n",
    "classListOfIcon: " + typeof classListOfIcon + "\n",
    "amountOfClasses: " + typeof amountOfClasses + "\n",
    "sizeTime: " + typeof sizeTime + "\n",
    "fontTime: " + typeof fontTime + "\n",
    "classNameInUpperCase: " + typeof classNameInUpperCase + "\n",
    "tag: " + typeof tag + "\n",
    "directionIcon: " + typeof directionIcon + "\n",
    "classListOfBackgroundIcon: " + typeof classListOfBackgroundIcon + "\n",
    "sizeElement: " + typeof sizeElement + "\n",
    "selection: " + typeof selection + "\n",
    "anchorNode: " + typeof anchorNode + "\n",
    "namesOfTags: " + typeof namesOfTags + "\n",
    "namesOfClasses: " + typeof namesOfClasses + "\n",
    "amountOfNames: " + typeof amountOfNames + "\n",
    "indexOfLastName: " + typeof indexOfLastName + "\n",
    "actives: " + typeof actives + "\n",
    "i: " + typeof i + "\n",
    "name: " + typeof name + "\n",
    "j: " + typeof j + "\n",
    "active: " + typeof active + "\n",
    "activeName: " + typeof activeName + "\n",
    "classListOfActive: " + typeof classListOfActive + "\n",
    "childNodesOfIcon: " + typeof childNodesOfIcon + "\n",
    "textOfIcon: " + typeof textOfIcon + "\n",
    "backgroundIcon: " + typeof backgroundIcon + "\n",
    "classListOfTag: " + typeof classListOfTag
  );
}
